    ...
    return(
        <div className='border-b p-4'>
            <div className='w-full items-center flex'>
                <div>
                    <div className={`bg-[#e44343] border border-[#753838] rounded-full w-[25px] ${styles.normalFlex} justify-center cursor-pointer`}
                    onClick={()=>setValue(value + 1)}
                    >
                        <HiPlus size={20} color="#fff"/>
                    </div>
                    <span className='pl-[10px]'>{value}</span>
                    <div className='bg-[#e44343] rounded-full w-[25px] flex h-[25px] justify-center cursor-pointer' onClick={()=>setValue(value=== 1 ? 1 : value -1)}>
